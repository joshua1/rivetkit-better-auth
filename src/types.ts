import { WherePredicate } from './transform-where'
...
export interface FullUser extends User, AdminUser, OrganizationUser, TwoFactorUser, OTPUser, UsernameUser, PhoneUser {
...
export interface DatabaseHook<T> {
	before?: (data: T, ctx: DatabaseHookContext) => Promise<{ data: T } | false | void>
...
export type AuthEntityWithRelations = UserWithRelations | SessionWithUser | AccountWithUser
...
export type AllAuthEntitiesWithRelations = AuthEntityWithRelations | PluginEntityWithRelations
...
export type TeamInvitationStatus = 'pending' | 'accepted' | 'rejected' | 'canceled'
