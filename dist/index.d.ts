...
declare function transformWhereClause(where?: CleanedWhere[]): (item: any) => boolean;
...
declare const defaultActions: <AD>() => {
    create: (c: any, params: AdapterCreateParams) => Promise<any>;
    findOne: <T>(c: any, params: AdapterFindParams) => Promise<T | null>;
    findMany: <T>(c: any, params: AdapterFindManyParams) => Promise<T[]>;
    update: <T>(c: any, params: AdapterUpdateParams) => Promise<T>;
    updateMany: (c: any, params: AdapterUpdateParams) => Promise<number>;
    delete: (c: any, params: AdapterDeleteParams) => Promise<never>;
    deleteMany: (c: any, params: AdapterDeleteParams) => Promise<any>;
    count: (c: any, params: AdapterCountParams) => Promise<number>;
};
